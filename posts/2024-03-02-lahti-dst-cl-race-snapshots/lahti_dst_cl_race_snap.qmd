---
title: "Lahti 20k Classic Interval Start Race Snapshots"
author: "Joran Elias"
date: "2024-03-02"
categories: [world cup,distance,race snapshots,interval start,classic,lahti]
draft: false
---
...
### Splits
```{r splits}
wom_splits <- dst_split_plot(.eventid = ev_id_w,ref_split = 1,omit_splits = 9.8)
men_splits <- dst_split_plot(.eventid = ev_id_m,ref_split = 1,omit_splits = 9.8)
```
