---
title: "Canmore 15k Freestyle Predictions"
author: "Joran Elias"
date: "2024-02-08"
categories: [world cup,distance,freestyle,mass start,predictions,canmore]
draft: false
---
...
tech <- "Freestyle"
mens_preds <- 
  readr::read_csv(file = '2024-02-09_men_fr_dst_canmore.csv',
                  show_col_types = FALSE)
womens_preds <- 
  readr::read_csv(file = '2024-02-09_wom_fr_dst_canmore.csv',
                  show_col_types = FALSE)
```

#### Men's 15k Freestyle Predictions
```{r tbl-men}
mens_preds |> 
  select(-compid) |> 
  gt() |> 
...
#### Women's 15k Freestyle Predictions
```{r tbl-wom}
womens_preds |> 
  select(-compid) |> 
  gt() |> 
...
dst_res <- v_dst_maj_int |> 
  filter(eventid %in% c(19777,19778)) |> 
  collect()
