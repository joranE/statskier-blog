---
title: "Oberhof 20k Classic Predictions"
author: "Joran Elias"
date: "2024-01-19"
categories: [world cup,distance,classic,mass start,predictions,oberhof]
draft: false
---
...
### Predictions
Maybe underrating Amundsen on the men's side here?
...
tech <- "Classic"
mens_preds <- 
  readr::read_csv(file = '2024-01-20_men_cl_dst_oberhof.csv',
                  show_col_types = FALSE)
womens_preds <- 
  readr::read_csv(file = '2024-01-20_wom_cl_dst_oberhof.csv',
                  show_col_types = FALSE)
```
...
dst_res <- v_dst_maj_int |> 
  filter(eventid %in% c(19522,19523)) |> 
  collect()
