...
#### Women's 15k Classic Predictions
```{r tbl-wom}
womens_preds |> 
  select(-compid) |> 
  gt() |> 
...
dst_res <- v_dst_maj_int |> 
  filter(eventid %in% c(19394,19395)) |> 
  collect()
...
Interesting! The men's predictions were worse than FIS point rankings, but they both
did pretty poorly. The women's side didn't have much of a difference.
