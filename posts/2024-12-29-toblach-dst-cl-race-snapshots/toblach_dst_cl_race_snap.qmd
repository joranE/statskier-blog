---
title: "Toblach 15k Classic Mass Start Race Snapshots"
author: "Joran Elias"
date: "2024-12-29"
categories: [tour de ski,distance,race snapshots,mass start,classic,toblach]
draft: false
---
...
m_pac <- 
  dst_pacing_plot(
    ...
    .subset = rank <= 9,
    n_laps = n_laps_men,
    omit_splits = c(1.4,5.2,8.9,12.7),
    collapse_short_seg = FALSE,
    title_text = glue(
      "Men's {location} {length}k {tech} {format}",
      location = race_location,
      length = race_length,
      tech = race_tech,
      format = race_format),
...
w_pac <- 
  dst_pacing_plot(
    ...
    collapse_short_seg = FALSE,
    title_text = glue(
      "Women's {location} {length}k {tech} {format}",
      location = race_location,
      length = race_length,
      tech = race_tech,
      format = race_format),
