---
title: "Trondheim 10k Freestyle Race Snapshots"
author: "Joran Elias"
date: "2025-12-07"
categories: [world cup,distance,race snapshots,freestyle,trondheim]
draft: false
---
...
p_men <- 
  race_snapshot_dst(
    event_id = ev_id_m,
    title = "Men's Trondheim 10k Freestyle",
    reduced = TRUE
  )
p_wom <- 
  race_snapshot_dst(
    event_id = ev_id_w,
    title = "Women's Trondheim 10k Freestyle",
    reduced = TRUE
  )
```
...
m_pac <- dst_pacing_plot(.eventid = ev_id_m,
                         ...
                         title_text = "Men's Trondheim 10k Freestyle",
...
w_pac <- dst_pacing_plot(.eventid = ev_id_w,
                         ...
                         #omit_splits = 2.3,
                         collapse_short_seg = FALSE,
                         title_text = "Women's Trondheim 10k Freestyle",
                         skip_first_split = FALSE)
```
#### Men
```{r men-pacing}
