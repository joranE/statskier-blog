...
dst_res <- v_dst_maj_int |> 
  filter(eventid %in% c(19590,19591)) |> 
  collect()

fis_pts <- arrow::read_parquet(file = '~/Documents/code/official-fis-points-lists/output/fis_pts_list_2024-01-10.parquet') |> 
...
Did a little worse on the men's side, only slightly better on the women.
