...
spr_res <- v_spr_maj_int |> 
  filter(eventid %in% c(19275,19274)) |> 
  collect()
...
I probably need a better baseline for comparison for sprint race predictions,
because FIS sprint points are a pretty absurd measure of overall sprint ability.

That said, my method did solidly better for the men, about the same for the women.
